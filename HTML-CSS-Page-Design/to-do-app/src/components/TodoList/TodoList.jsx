    ...
    <div className="bg-white rounded-2xl p-8 mx-auto mb-12 max-w-[800px] shadow-[0_10px_30px_rgba(0,0,0,0.08)] backdrop-blur-md border border-[rgba(176,190,197,0.2)] animate-slideUp">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-10 pb-8 border-b-2 border-gray-100">
        ...
        <div
          ...
          className="cursor-pointer text-center p-6 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 text-white"
        >
          <span className="block text-[13px] font-semibold uppercase mb-2">Total</span>
        ...
        <div
          ...
          className="cursor-pointer text-center p-6 rounded-xl bg-gradient-to-br from-emerald-300 to-emerald-400"
        >
          <span className="block text-[13px] font-semibold uppercase mb-2">Completed</span>
        ...
        <div
          ...
          className="cursor-pointer text-center p-6 rounded-xl bg-gradient-to-br from-red-400 to-red-500 text-white"
        >
          <span className="block text-[13px] font-semibold uppercase mb-2">Remaining</span>
