      ...
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="flex items-center gap-1">
            ...
            />
            <span
              className={`font-semibold text-base text-gray-800 transition-all ${
          ...
          {(todo.priority || todo.dueDate) && (
            <div className="flex flex-wrap gap-3 text-xs pl-5 md:pl-8">
              ...
              {todo.dueDate && (
                <span className="inline-flex items-center bg-gray-100 px-3 py-1 rounded-full font-medium text-gray-700">
        ...
        <div className="flex items-center gap-2 pt-1">
          {!todo.completed && (
            <button
              onClick={() => onEdit(todo)}
              className="flex items-center justify-center w-7 h-7 rounded-md bg-gradient-to-br from-indigo-500 to-purple-600 text-white shadow-[0_4px_12px_rgba(102,126,234,0.3)] transition-all duration-300 ease-in-out hover:-translate-y-[2px] hover:shadow-[0_6px_16px_rgba(102,126,234,0.4)]"
              title="Edit"
            >
              <FaEdit size={14} />
            </button>
          ...
          <button
            onClick={handleDeleteClick}
            className={`flex items-center justify-center w-7 h-7 rounded-md text-white transition-all duration-300 ease-in-out hover:-translate-y-[2px]
        ${
          todo.completed
            ? "bg-gradient-to-br from-green-500 to-green-600 hover:shadow-[0_6px_16px_rgba(34,197,94,0.4)]"
            : "bg-gradient-to-br from-red-500 to-red-600 hover:shadow-[0_6px_16px_rgba(239,68,68,0.4)]"
        }`}
            title={todo.completed ? "Clean Up" : "Delete"}
          >
            {todo.completed ? <FaCheck size={14} /> : <FaTrash size={14} />}
